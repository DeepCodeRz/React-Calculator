...
export default function Keyboard(props) {
    ...
    const operations = ["+", "-", "*", "/"];
    const functionalities = ["Clean", "Result"];
    ...
    return (
        <div className="w-80 p-4 flex-col justify-center items-center border border-border rounded-xl shadow-md dark:bg-gray-800 dark:text-gray-300 dark:hover:text-white dark:border-gray-700">
            <div className="flex items-start justify-start">
                <Key key={"clear"} type="clear" calculation={props.calculation}
                     setCalculation={props.setCalculation}></Key>
                <Key key={"result"} type="result" calculation={props.calculation} setCalculation={props.setCalculation}>=</Key>
            </div>
